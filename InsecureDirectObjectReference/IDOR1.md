...
Ось переклад тексту, адаптований під термінологію веб-безпеки та розробки:

## Гра з шаблонами (Playing with the Patterns)

### Перегляд іншого профілю
Переглядаємо профіль іншого користувача, скориставшись тим самим альтернативним шляхом, який ми вже використовували для перегляду власного профілю. Скористаймося кнопкою **"View Profile"** (Переглянути профіль), перехопіть та модифікуйте запит, щоб побачити дані іншої особи. Крім того, ви можете спробувати просто надіслати ручний **GET-запит** через браузер.
